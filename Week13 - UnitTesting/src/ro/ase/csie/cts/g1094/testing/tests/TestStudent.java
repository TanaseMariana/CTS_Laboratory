...
public class TestStudent {
	...
	@Test
	public void testGetGradeAverageAscendingOrder() throws WrongGradesException {
		...
		assertEquals("Testing with an ascending sorted set of grades",expectedAverage,computedAverage,0);
	}
	...
	public void testGetGradesAverageCardinalityZero() throws WrongGradesException {
		...
		assertEquals("Testing with no grades;",expectedAverage,computedAverage,0);
	}
